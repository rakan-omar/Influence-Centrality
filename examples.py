...
def hierarchy():
    G = nx.DiGraph()
    G.add_nodes_from([(1, {'value':0.5}), (2, {'value':0.5}), (3, {'value':0.5}), (4, {'value':0.6}), (5, {'value':0.7}), (6, {'value':0.7}), (7, {'value':0.7}), (8, {'value':0.8}),
                      (8, {'value':0.9}), (9, {'value':0.9})])
...
def path():
  ...
  #  G.add_nodes_from([(1, {'value':1}), (2, {'value':1}), (3, {'value':1}),(4, {'value':1}), (5, {'value':1})])
   # G.add_weighted_edges_from([(1, 2, 0.7), (2, 3, 0.7), (3, 4, 0.7), (4, 5, 0.7)])
    G.add_nodes_from([(1, {'value':1}), (2, {'value':1}), (3, {'value':1}),(4, {'value':1}), (5, {'value':1}), (6, {'value':1}), (7, {'value':1}), (8, {'value':1})])
    G.add_weighted_edges_from([(1, 2, 0.4), (2, 3, 0.6), (3, 4, 0.3), (4, 5, 0.5), (3, 6, 0.2), (7, 2, 0.1), (6, 7, 0.5), (7, 8, 0.4), (5, 6, 0.35)])
    return G
...
def complex_trail():
    ...
    G.add_weighted_edges_from([(1, 2, 0.15), (2, 12, 0.1), (3, 4, 0.2), (5, 8, 0.5), (1, 5, 0.2), (5, 6, 0.1), (6, 9, 0.4), (19, 20, 0.3),
                            (20, 2, 0.3), (4, 13, 0.2), (7, 14, 0.1), (15, 12, 0.3), (11, 10, 0.05), (10, 9, 0.1), (9, 12, 0.1), (9, 10, 0.2), (11, 18, 0.1),
                            (19, 18, 0.3), (18, 16, 0.2), (17, 20, 0.6), (17, 13, 0.1), (12, 18, 0.1), (9, 2, 0.1), (3, 5, 0.1), (2, 7, 0.1), (9, 10, 0.1),
                            (13, 2, 0.1), (2, 17, 0.5), (15, 16, 0.3), (16, 11, 0.4)])
    return G
